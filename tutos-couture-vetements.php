...
<html lang="fr">
  <head>
    <meta charset="utf-8">
    <link href="styles/categorie-b.css" rel ="stylesheet" type="text/css"/>
	...
	<meta name="description" content="couture vêtement, patron vêtement, tuto couture vêtement "/>
    <meta name="viewport" content="width=device-width"/>
    <title>tutos couture vêtements</title>	
  </head>
    ...
    <header>
	  ...
	  <input type="checkbox" id="nav" /><label for="nav"></label>
        <ul id="menu-deroulant">
          ...
          <li id="selection"><a href="tutos-couture.html">Tutos couture</a> 
           <ul>
              <li class="sousmd"><a href="tutos-couture-vêtements.html">- Vêtements</a></li>
              <li class="sousmd"><a href="tutos-couture-accessoires.html">- Accessoires</a></li>
           </ul>
		  </li>
		  <li class="sousmenu"><a href="idees-rangements-atelier.html">Idées de rangements pour atelier de couture</a></li>
...
<hr/>
	<footer><!--balise structurante pied de page-->
		<p><a href="mentions.html">| Mentions légales</a> | <a href="equipe.html">Plan du site</a> <!-- les catégories, les tags, les pages, 
